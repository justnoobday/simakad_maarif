    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
               <b>SISTEM INFORMASI AKADEMIK</b> <br>SMK MA'ARIF CIDAUN</a>
            </div>
            <!-- /.login-logo -->
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-xs-12">
                        <div class="callout callout-info">
                            <a class="btn btn-danger btn-block btn-flat" href="<?php echo base_url();?>index.php/auth/login_guru">Login Guru</a>
                        </div>
                    </div>
